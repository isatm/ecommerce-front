            ...
            <div className="flex h-screen gap-4">
              <div className="w-1/2 flex text-sm hidden lg:flex border-gray-200 justify-center">
                ...
                <ToggleButtonComponent
                  options={['Guitarras', 'Pedales y amplificadores', 'Teclados y Sintetizadores', 'Equipo de grabación', 'Baterias','Equipo Dj y audio','Más categorías']}
                  buttonStyle="text-black hover:text-orange-400 font-medium py-2 px-4 rounded-lg transition" content="Ver todo"/>
              </div>
              <div className="w-1/2 flex text-sm hidden lg:flex border-gray-200 justify-center">
                <ButtonComponent type={1} content="Marcas" />
                <a href="news" className="text-black hover:text-orange-400 font-medium py-2 px-4 rounded-lg transition">Noticias</a>
                <ButtonComponent type={1} content="Explorar" />
                <a href="news" className="text-black hover:text-orange-400 font-medium py-2 px-4 rounded-lg transition">Tiendas de artistas</a>
                <a href="news" className="text-black hover:text-orange-400 font-medium py-2 px-4 rounded-lg transition">Reverb Gives</a>
                <a href="news" className="text-black hover:text-orange-400 font-medium py-2 px-4 rounded-lg transition">Centro de ayuda</a>
